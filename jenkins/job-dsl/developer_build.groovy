pipelineJob('developer_build') {
    ...
    parameters {
        ...
        stringParam('LOCATION_SERVICE_BRANCH', 'main', 'Branch for location-service')
        stringParam('TAX_SERVICE_BRANCH', 'main', 'Branch for tax-service')
        stringParam('MEDIA_SERVICE_BRANCH', 'main', 'Branch for media-service')
        stringParam('PAYMENT_SERVICE_BRANCH', 'main', 'Branch for payment-service')
...
pipelineJob('developer_build_cleanup') {
    ...
    parameters {
        ...
        booleanParam('RESET_LOCATION', false, 'Reset location-service to main')
        booleanParam('RESET_PAYMENT', false, 'Reset payment-service to main')
