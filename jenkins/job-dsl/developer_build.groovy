pipelineJob('developer_build') {
    ...
    parameters {
        ...
        stringParam('TAG_RATING', 'main', 'Branch name for rating')
        stringParam('TAG_CUSTOMER', 'main', 'Branch name for customer')
        stringParam('TAG_LOCATION', 'main', 'Branch name for location')
        stringParam('TAG_INVENTORY', 'main', 'Branch name for inventory')
        stringParam('TAG_SEARCH', 'main', 'Branch name for search')
        stringParam('TAG_PAYMENT', 'main', 'Branch name for payment')
        stringParam('TAG_PAYMENT_PAYPAL', 'main', 'Branch name for payment-paypal')
        stringParam('TAG_PROMOTION', 'main', 'Branch name for promotion')
        stringParam('TAG_RECOMMENDATION', 'main', 'Branch name for recommendation')
        stringParam('TAG_SAMPLEDATA', 'main', 'Branch name for sampledata')
        stringParam('TAG_WEBHOOK', 'main', 'Branch name for webhook')
